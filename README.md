...
- 우승자는 한 명 이상일 수 있다
  - 우승자가 여러명일 경우 ,로 구분한다
- 전진 조건은 0~9 사이의 무작위 값이 4이상일 경우 전진할 수 있다
- 입력을 잘못 했을 시 잘못 입력한 부분부터 다시 입력이 가능하게 한다
# 기능 목록
- [x] 자동차 이름을 입력받아 자동차를 생성하는 기능
- [x] 이동 횟수만큼 모든 자동차에 대해 전진을 시도해보는 기능
  - [x] 랜덤값을 생성하는 기능
  - [x] 자동차의 전진을 시도해보는 기능
- [x] 우승자를 도출하는 기능
  - [x] 어떤 자동차가 더 멀리갔는지 비교하는 기능
# 예외처리
## 자동차 이름
- [x] 자동차 이름이 5자를 초과한 경우

## 시도 횟수
- [x] Integer로 파싱을 실패한 경우
- [ ] 시도 횟수가 자연수가 아닌 경우
